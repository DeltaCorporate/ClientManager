...
!function (t, e) {
    ...
    function Vi(t, e, i) {
        ...
        const {property: s, start: n, end: o} = i, a = e.length, {
            ...
            between: l,
            normalize: h
        } = Fi(s), {start: c, end: d, loop: u, style: f} = function (t, e, i) {
    ...
    function Fn(t, e, i, s, n) {
        ...
        const g = (f - Math.max(.001, f * c - i / _t) / c) / 2, p = r + g + u, m = n - g - u, {
                outerStart: x,
                outerEnd: b,
                innerStart: _,
                innerEnd: y
            } = In(e, d, c, m - p), v = c - x, w = c - b, M = p + x / v, k = m - b / w, S = d + _, P = d + y, D = p + _ / S,
            C = m - y / P;
    ...
    class Do extends Ds {
        ...
        fit() {
            ...
            const i = t.labels, s = He(i.font), n = s.size, o = this._computeTitleHeight(), {
                boxWidth: a,
                itemHeight: r
            } = Po(i, n);
            let l, h;
        ...
        adjustHitBoxes() {
            ...
            } = this, a = Ei(o, this.left, this.width);
            if (this.isHorizontal()) {
    ...
    class Oo extends Ds {
        ...
        draw() {
            ...
            if (!e.display) return;
            const i = He(e.font), n = i.lineHeight / 2 + this._padding.top, {
                titleX: o,
                titleY: a,
                maxWidth: r,
                rotation: l
    ...
    class $o extends Ds {
        ...
        getCaretPosition(t, e, i) {
            const {xAlign: s, yAlign: n} = this, {caretSize: o, cornerRadius: a} = i, {
                ...
                bottomLeft: h,
                bottomRight: c
            } = We(a), {x: d, y: u} = t, {width: f, height: g} = e;
            let p, m, x, b, _, y;
        ...
        buildTicks() {
            ...
            const s = function (t, e) {
                const i = [], {
                        ...
                        maxDigits: c,
                        includeBounds: d
                    } = t, u = n || 1, f = h - 1, {min: g, max: p} = e, m = !$(o), x = !$(a), b = !$(l),
                    _ = (p - g) / (c + 1);
    ...
    class la extends Go {
        ...
        drawGrid() {
            ...
            if (e.pointLabels.display && function (t, e) {
                ...
                for (let n = e - 1; n >= 0; n--) {
                    const e = s.setContext(t.getPointLabelContext(n)), o = He(e.font), {
                        x: a,
                        y: r,
                        textAlign: l,
                        left: h,
